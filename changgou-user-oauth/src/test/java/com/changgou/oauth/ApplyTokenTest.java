...
public class ApplyTokenTest {
    ...
    public void applyToken(){
        ...
        //构建请求地址  http://localhost:9200/oauth/token  通过loadBalanceClient 来获取注册中心的服务名称
    ...
    private String getHttpBasic(String clientId, String clientSecret) {
        ...
        String changgou = BCrypt.hashpw("changgou", gensalt);
        boolean checkpw = BCrypt.checkpw(changgou, gensalt);
